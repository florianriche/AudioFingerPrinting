...
public class Signature {
	...
	public static int firstOne(boolean[] vecteur, int seed) {
		...
		/**
		 * HashMap utilisée pour éviter de tester deux fois le même chiffre.
		 * Est-ce obligatoire?
		 */
	...
	public static byte[] fingerprint(boolean[] original, int p) {
		...
		/** Trouve le premier 1 et l'ajoute � la signature. */
	...
	/*public static void main(String[] args) {
		...
		/**
		 * Cr�ation de la signature de la matrice ( p : 50 ici)
